...
PACKAGE_URL = 'https://github.com/haohoangofficial/executor'
PACKAGE_DOWNLOAD_URL = \
    'https://github.com/haohoangofficial/executor/tarball/' + PACKAGE_VERSION
PACKAGES = [
    'executor',
    'executor.test',
    'executor.utils',
    'executor.requests',
    'executor.selenium.remote',
...
PACKAGE_DESCRIPTION = 'Python Crawling Executors'
